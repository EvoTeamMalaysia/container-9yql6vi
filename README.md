...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-9yql6vi.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-9yql6vi.containers.anotherwebservice.com/
...
```
git clone git@github.com:EvoTeamMalaysia/container-9yql6vi.git
cd container-9yql6vi
```
...
```
docker attach container-9yql6vi
```
